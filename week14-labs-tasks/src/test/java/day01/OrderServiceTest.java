...
class OrderServiceTest {
    ...
    @Test
    void testNumberOfOrdersByStatus(){

        System.out.println(orderService.numberOfOrdersByStatus("pending"));
    }



    @Test
    void testGetOrdersHaveCategory(){

        System.out.println(orderService.getOrdersHaveCategory("IT").size());
    }
